...
# Setup close-sublist event listener
...
'''
js = re.sub(r'function renderCategoryList\(\) \{.*?\n\}\n(?=else if \(diff)', render_category_new, js, flags=re.DOTALL)
...
'''
js = re.sub(r'function renderChannelList\(\) \{.*?\n\}\n', render_channel_new, js, flags=re.DOTALL)
...
print("Right pane split layout for Channels and Categories implemented.")
